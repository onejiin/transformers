...
from ..bert_FNet.modeling_fnetbert import (
    FNetBertForMaskedLM,
...
MODEL_FOR_PRETRAINING_MAPPING = OrderedDict(
    [
        ...
        (FNetBertConfig, FNetBertForPreTraining),
...
MODEL_WITH_LM_HEAD_MAPPING = OrderedDict(
    [
        ...
        (FNetBertConfig, FNetBertForMaskedLM),
        (OpenAIGPTConfig, OpenAIGPTLMHeadModel),
        (GPT2Config, GPT2LMHeadModel),
...
MODEL_FOR_CAUSAL_LM_MAPPING = OrderedDict(
    [
        ...
        (FNetBertConfig, FNetBertLMHeadModel),
        (OpenAIGPTConfig, OpenAIGPTLMHeadModel),
        (GPT2Config, GPT2LMHeadModel),
        (TransfoXLConfig, TransfoXLLMHeadModel),
        (XLNetConfig, XLNetLMHeadModel),
...
MODEL_FOR_SEQUENCE_CLASSIFICATION_MAPPING = OrderedDict(
    [
        ...
        (FNetBertConfig, FNetBertForSequenceClassification),
...
MODEL_FOR_QUESTION_ANSWERING_MAPPING = OrderedDict(
    [
        ...
        (FNetBertConfig, FNetBertForQuestionAnswering),
...
MODEL_FOR_TOKEN_CLASSIFICATION_MAPPING = OrderedDict(
    [
        ...
        (FNetBertConfig, FNetBertForTokenClassification),
...
MODEL_FOR_MULTIPLE_CHOICE_MAPPING = OrderedDict(
    [
        ...
        (FNetBertConfig, FNetBertForMultipleChoice),
...
MODEL_FOR_NEXT_SENTENCE_PREDICTION_MAPPING = OrderedDict(
    [
        ...
        (FNetBertConfig, FNetBertForNextSentencePrediction),
