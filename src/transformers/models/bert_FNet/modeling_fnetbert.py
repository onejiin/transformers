...
from .configuration_fnetbert import FNetBertConfig


logger = logging.get_logger(__name__)

_CHECKPOINT_FOR_DOC = "fnetbert-base-uncased"
_CONFIG_FOR_DOC = "FNetBertConfig"
_TOKENIZER_FOR_DOC = "FNetBertTokenizer"

FNetBERT_PRETRAINED_MODEL_ARCHIVE_LIST = [
    "fnetbert-base-uncased",
    "fnetbert-large-uncased",
    "fnetbert-base-cased",
    "fnetbert-large-cased",
...
class FNetBertModel(BertPreTrainedModel):
    """
...
class BertForPreTraining(BertPreTrainedModel):
    def __init__(self, config):
        ...
        self.bert = FNetBertModel(config)
...
class BertLMHeadModel(BertPreTrainedModel):
    ...
    def __init__(self, config):
        ...
        self.bert = FNetBertModel(config, add_pooling_layer=False)
